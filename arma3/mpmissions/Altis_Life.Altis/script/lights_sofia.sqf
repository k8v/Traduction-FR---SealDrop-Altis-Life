if (life_kw_sofia) exitWith {hintSilent "Du hast das Kraftwerk bereits ausgeschaltet"};
...
if(playerSide == civilian) then
{
	...
	[[0,format["!!! %1 de la centrale électrique de Sofia a été désactivé !!!", name player]],"life_fnc_broadcast",west,false] spawn life_fnc_MP;
	uiSleep 300;
	life_kw_sofia = false;
};