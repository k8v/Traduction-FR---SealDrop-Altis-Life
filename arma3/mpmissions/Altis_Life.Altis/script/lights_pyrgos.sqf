if (life_kw_pyrgos) exitWith {hintSilent "Du hast das Kraftwerk bereits ausgeschaltet"};
...
if(playerSide == civilian) then
{
	...
	[[0,format["!!! %1 de la centrale électrique de Pyrgos a été désactivé !!!", name player]],"life_fnc_broadcast",west,false] spawn life_fnc_MP;
	uiSleep 300;
