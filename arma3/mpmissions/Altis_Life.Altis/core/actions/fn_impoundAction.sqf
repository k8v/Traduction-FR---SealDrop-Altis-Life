...
if((_vehicle isKindOf "Car") || (_vehicle isKindOf "Air") || (_vehicle isKindOf "Ship")) then
{
	...
	//if(isNil {_time}) exitWith {deleteVehicle _vehicle; hintSilent "Ce véhicule a été crocheté"};
	//if((time - _time)  < 120) exitWith {hintSilent "Ce véhicule vient d'apparaître, vous ne pouvez pas le mettre en fourrière."};
