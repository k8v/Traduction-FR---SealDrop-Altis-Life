...
if(!(_building isKindOf "House_F")) exitWith {hintSilent "Vous n'êtes pas en train de regarder la porte."};
...
if(_door == 0) exitWith {hintSilent localize "STR_Cop_NotaDoor"}; //Not near a door to be broken into.
if((_building getVariable[format["bis_disabled_Door_%1",_door],0]) == 0) exitWith {hintSilent localize "STR_House_Raid_DoorUnlocked"};
