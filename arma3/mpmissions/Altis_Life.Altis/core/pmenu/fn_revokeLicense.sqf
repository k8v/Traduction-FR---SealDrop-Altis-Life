...
if(isNull _curTarget) exitWith {hintSilent "Mauvaise cible!"; closeDialog 0;}; //Bad target
if(!isPlayer _curTarget && side _curTarget == civilian) exitWith {hintSilent "Vous ne pouvez pas faire cette action."; closeDialog 0;}; //Bad side check?
