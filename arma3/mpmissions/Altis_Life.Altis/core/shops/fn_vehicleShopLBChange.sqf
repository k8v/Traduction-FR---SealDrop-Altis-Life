...
"Prix location: <t color='#8cff9b'>$%1</t><br/>Prix d'achat: <t color='#8cff9b'>$%2</t><br/>Vitesse max: %3 km/h<br/>Chevaux: %4<br/>Siège passager: %5<br/>Coffre: %6<br/>Réservoir: %7<br/>Blindage: %8",
