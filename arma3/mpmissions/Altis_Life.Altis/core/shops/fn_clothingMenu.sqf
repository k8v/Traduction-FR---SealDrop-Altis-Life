...
{
	if(!(missionNamespace getVariable (_var select 0))) exitWith {hintSilent format["tu dois avoir %1 pour utiliser ce magasin",[_var select 0] call life_fnc_varToStr]; closeDialog 0;};
};
