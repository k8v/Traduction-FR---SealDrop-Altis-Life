...
*/
if(life_action_inUse) exitWith {hintSilent "Tu fais déja quelque chose.."};
...
//Error check
if(count _nearVehicles == 0) exitWith {titleText["Il n'y a pas de véhicule à vendre à proximité.","PLAIN"];};
if(!(createDialog "Chop_Shop")) exitWith {hintSilent "Il y a eu un souci pour ouvrir le menu."};
