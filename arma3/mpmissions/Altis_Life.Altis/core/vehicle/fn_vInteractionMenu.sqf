...
if ((playerSide isEqualTo civilian) && typeOf (_curTarget) in ["C_Kart_01_Blu_F","C_Kart_01_Red_F","C_Kart_01_Fuel_F","C_Kart_01_Vrana_F","B_Heli_Transport_03_F","B_Heli_Transport_03_unarmed_F","O_Heli_Transport_04_F","O_Heli_Transport_04_ammo_F","O_Heli_Transport_04_bench_F","O_Heli_Transport_04_box_F","O_Heli_Transport_04_covered_F","O_Heli_Transport_04_fuel_F","O_Heli_Transport_04_medevac_F","O_Heli_Transport_04_repair_F"]) then {
	_Btn6 ctrlSetText "Monter";
...
if((playerSide isEqualTo independent) && ((speed _curTarget) isEqualTo 0) && (_curTarget in life_vehicles)) then {
	_Btn5 ctrlShow true;
	_Btn5 ctrlSetText "Remorquer";
...
if(playerSide isEqualTo west) then {
	...
	if((playerSide isEqualTo civilian) && license_civ_rebel && {speed _curTarget isEqualTo 0} && _curTarget in life_vehicles) then
	{
